...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/app/vendor/ruby-2.4.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/tmp/new_ruby/app/vendor/ruby-2.4.0' '--disable-install-doc' '--prefix' '/app/vendor/ruby-2.4.0' '--enable-load-relative' 'LDFLAGS=-L/tmp/new_ruby/app/vendor/ruby-2.4.0/lib ' 'CPPFLAGS=-I/tmp/new_ruby/app/vendor/ruby-2.4.0/include '"
  ...
  CONFIG["DLDLIBS"] = " -lc"
  CONFIG["SOLIBS"] = ""
  CONFIG["LIBRUBYARG_SHARED"] = "-Wl,-R$(libdir) "
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/tmp/new_ruby/app/vendor/ruby-2.4.0/lib "
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Ubuntu 4.8.4-2ubuntu1~14.04.1) 4.8.4\nCopyright (C) 2013 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/tmp/new_ruby/app/vendor/ruby-2.4.0/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/tmp/new_ruby/app/vendor/ruby-2.4.0/lib  -fstack-protector -rdynamic -Wl,-export-dynamic"
